...
The [MLP selection study](mlp-selection-v1/README.md) now declares the five remaining configurations and a fixed tie-break rule. Its inputs and hypotheses are registered before execution; the new candidates have no measured results yet. Five slots are evaluated and five are reserved by this plan.
