...
The [inference benchmark](inference-v1/README.md) measures these delivery bundles' size, learned parameters, startup, warm request latency, and throughput on the 519 validation texts. Its fixed CPU protocol, environment, source and artifact hashes, and raw timings accompany the results. This describes inference cost without changing the models or evaluating test.
